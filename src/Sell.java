...
public class Sell extends javax.swing.JFrame {
    ...
    private void backActionPerformed(java.awt.event.ActionEvent evt) {
        try {
            String sql = "SELECT rent_price FROM house_sell WHERE house_number=? AND floor=?";
            ...
            if (rs.next()) {
                ...
                long result = rs.getInt("rent_price");
    ...
    private void jAddActionPerformed(java.awt.event.ActionEvent evt) {
        try {
            JOptionPane.showMessageDialog(null, "Успішно продано...");
            houseAreSold();
            setVisible(false);
    ...
    private void houseAreSold(){
        try {
            String query = "UPDATE house_sell SET status = FALSE WHERE  house_number=? AND apartment_number=?";
